...
![](./Screenshot/game-desktop-1.png)
![](./Screenshot/game-desktop-2.png)
![](./Screenshot/game-mobile-2.png)
...
- [Grid System - Bootstrap](https://getbootstrap.com/docs/5.3/layout/grid/) - This website helped me to execute some of the styling that I created in the wireframe. This also helped with the gameboard formatting and easy spacing within the style of the 

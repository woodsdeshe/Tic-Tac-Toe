...
```
- I also had some difficulties trying to incorporate resposive design in my code and had to do a creash course in Bootstrap in order to simplify the proces. Being able to figure out how to recreate my game board using Boostrap was 
```html

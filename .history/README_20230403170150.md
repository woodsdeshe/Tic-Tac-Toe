...
- Array methods: I was able to discover more methods for arays like the .every method, but it was still something that I struggled to incorporate into my code. I hope to be able to use these methods more 

...
function checkForWinner() {
  ...
  for (let i = 0; i < winningPlays.length; i++) {
    ...
    // Create if/else conditions that will check to see if the current player has a winning play thats in 'winningPlays', if no one wins, it calls the "itsATie function "

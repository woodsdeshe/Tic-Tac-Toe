...
function checkForWinner() {
  ...
  for (let i = 0; i < winningPlays.length; i++) {
    ...
    // Create if/else conditions that will check to see if the current player has a winning play thats in 'winningPlays', if no one wins, it calls the "itsATie function to alert the players that the game is over and prevents the players from continuing to play using th "

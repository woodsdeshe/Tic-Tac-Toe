...
function resetGame() {
  ...
  //This for loop iterates through the tiles and clears them and makes them clickable again
  // Clear the board by setting the text content of all tiles to an empty string
  tile.forEach((tile) => {
    tile.textContent = "";
  });
...
// This function handles clicks on the tiles

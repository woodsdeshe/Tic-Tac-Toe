...
// This event listener resets all the values of the game to the default value when the reset button is clicked and calls the resetGame function to reset tile va
